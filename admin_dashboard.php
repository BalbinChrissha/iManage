...
<?php if (isset($_SESSION['admin'])) : ?>
  ...
  $sql1 = "SELECT item.categoryID, category_name, sum(quantity) as totalqty FROM item, category, supply_office_staff WHERE category.categoryID = item.categoryID AND supply_office_staff.staffID=item.staffID AND category.categoryID= 1  GROUP BY category.categoryID";
  ...
  ////januray
  $sql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='january' AND year =2023 GROUP BY category.categoryID";
  ...
  //////////////////February///////////////////////////////
  $sqlfeb1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='february' AND year =2023 GROUP BY category.categoryID";
  ...
  // MARCHHHHHHHHHHHHHH
  $marchsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='march' AND year =2023 GROUP BY category.categoryID";
  ...
  /// APRIL
  $aprilsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='april' AND year =2023 GROUP BY category.categoryID";
  ...
  /// JUNE
  $junesql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='june' AND year =2023 GROUP BY category.categoryID";
  ...
  /// JULY
  $julysql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='july' AND year =2023 GROUP BY category.categoryID";
  ...
  /// AUGUST
  $augsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='august' AND year =2023 GROUP BY category.categoryID";
  ...
  /// SEPTEMBER
  $septsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='september' AND year =2023 GROUP BY category.categoryID";
  ...
  /// OCTOBER
  $octsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='october' AND year =2023 GROUP BY category.categoryID";
  ...
  /// NOVEMBER
  $novsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='november' AND year =2023 GROUP BY category.categoryID";
  ...
  /// DECEMBER
  $decsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 1 AND month='december' AND year =2023 GROUP BY category.categoryID";
    ...
    <div class="col-sm-8 mx-auto p-5">
      ...
      <h5 style="text-align: justify;"><?php
                                        if (($totaltransfer == 0) && ($remainder == 0) && ($totalqty == 0)) {
                                          echo "No equipment handling yet";
  ...
  $sql1 = "SELECT item.categoryID, category_name, sum(quantity) as totalqty FROM item, category, supply_office_staff WHERE category.categoryID = item.categoryID AND supply_office_staff.staffID=item.staffID AND category.categoryID= 2 GROUP BY category.categoryID";
  $totalfetch = mysqli_query($db, $sql1);
  if (mysqli_num_rows($totalfetch) > 0) {
    $data1 = mysqli_fetch_assoc($totalfetch);
    ...
    <div class="col-sm-8 mx-auto p-5">
      ...
      <h5 style="text-align: justify;"><?php
                                        ...
                                        if (($totaltransfer2 == 0) && ($remainder2 == 0) && ($totalqty2 == 0)) {
                                          echo "No supply handling yet";
                                        } else if (($totaltransfer2 == 0) && ($remainder2 == $totalqty2)) {
                                          echo "100% of the equipment inventory, or " . $totalqty2 . " items, have not been transferred to a Faculty In Charge.";
  ...
  ////januray
  $sql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='january' AND year =2023 GROUP BY category.categoryID";
  $dataset1 = mysqli_query($db, $sql1);
  if (mysqli_num_rows($dataset1) > 0) {
    $data1 = mysqli_fetch_assoc($dataset1);
  ...
  //////////////////February///////////////////////////////
  $sqlfeb1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='february' AND year =2023 GROUP BY category.categoryID";
  $febdataset1 = mysqli_query($db, $sqlfeb1);
  if (mysqli_num_rows($febdataset1) > 0) {
    $febdata = mysqli_fetch_assoc($febdataset1);
  ...
  // MARCHHHHHHHHHHHHHH
  $marchsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='march' AND year =2023 GROUP BY category.categoryID";
  $marchdataset1 = mysqli_query($db, $marchsql1);
  if (mysqli_num_rows($marchdataset1) > 0) {
    $marchdata = mysqli_fetch_assoc($marchdataset1);
  ...
  /// APRIL
  $aprilsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='april' AND year =2023 GROUP BY category.categoryID";
  $aprildataset1 = mysqli_query($db, $aprilsql1);
  if (mysqli_num_rows($aprildataset1) > 0) {
    $aprildata = mysqli_fetch_assoc($aprildataset1);
  ...
  /// JUNE
  $junesql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='june' AND year =2023 GROUP BY category.categoryID";
  $junedataset1 = mysqli_query($db, $junesql1);
  if (mysqli_num_rows($junedataset1) > 0) {
    $junedata = mysqli_fetch_assoc($junedataset1);
  ...
  /// JULY
  $julysql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='july' AND year =2023 GROUP BY category.categoryID";
  $julydataset1 = mysqli_query($db, $julysql1);
  if (mysqli_num_rows($julydataset1) > 0) {
    $julydata = mysqli_fetch_assoc($julydataset1);
  ...
  /// AUGUST
  $augsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='august' AND year =2023 GROUP BY category.categoryID";
  $augdataset1 = mysqli_query($db, $augsql1);
  if (mysqli_num_rows($augdataset1) > 0) {
    $augdata = mysqli_fetch_assoc($augdataset1);
  ...
  /// SEPTEMBER
  $septsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='september' AND year =2023 GROUP BY category.categoryID";
  $septdataset1 = mysqli_query($db, $septsql1);
  if (mysqli_num_rows($septdataset1) > 0) {
    $septdata = mysqli_fetch_assoc($septdataset1);
  ...
  /// OCTOBER
  $octsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='october' AND year =2023 GROUP BY category.categoryID";
  $octdataset1 = mysqli_query($db, $octsql1);
  if (mysqli_num_rows($octdataset1) > 0) {
    $octdata = mysqli_fetch_assoc($octdataset1);
  ...
  /// NOVEMBER
  $novsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='november' AND year =2023 GROUP BY category.categoryID";
  $novdataset1 = mysqli_query($db, $novsql1);
  if (mysqli_num_rows($novdataset1) > 0) {
    $novdata = mysqli_fetch_assoc($novdataset1);
  ...
  /// DECEMBER
  $decsql1 = "SELECT category_name, sum(available_qty) as available_qty, sum(unavailable1_qty) as unavailable1_qty, sum(unavailable2_qty) as unavailable2_qty, month, year FROM item, supply_office_staff, category, item_transfer, item_last_checked , item_state WHERE category.categoryID=item.categoryID AND item.itemid=item_transfer.itemID AND item_transfer.recordno=item_state.recordno AND item_state.checkedID = item_last_checked.checkedID AND supply_office_staff.staffID=item.staffID AND category.categoryID = 2 AND month='december' AND year =2023 GROUP BY category.categoryID";
  $decdataset1 = mysqli_query($db, $decsql1);
  if (mysqli_num_rows($decdataset1) > 0) {
    $decdata = mysqli_fetch_assoc($decdataset1);
