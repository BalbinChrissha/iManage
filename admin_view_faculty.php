...
<?php if (isset($_SESSION['admin'])) : ?>
    ...
    <div class="col-10 mx-auto my-5 bg-light rounded">
        ...
        <div class="col-sm-12 mx-auto p-5">
            <?php
            $dataset = $db->query("SELECT * from faculty_incharge WHERE facultyID = $facultyID") or die("Error Query");
            ...
            ?>
            <center>
                <h3><b>TRANSFERRED ITEMS TO : <?php echo  strtoupper($name); ?></b></h3>
            </center><br>
            <div class="row">
                ...
                <div class="col-sm-10 mb-2" align="right">
                    ...
                    <!-- <button type="button" onclick="location.href='admin_view_faculty.php?facultyid=<?php echo $facultyID; ?>'" class="btn btn-primary">Print Transfer Report</button> -->
      ...
      <td>$data[7]</td>
      <td>$data[8]</td>
      <td> <a href=\"admin_view_faculty_datachart.php?facultyid=$facultyID && recordno=" . $data[0] . " && catID=" . $data[9] . "\" ><i  input type=\"edit\"  class=\"fa-solid fa-eye\" style=\"color:blue;\"></i> Analytics</a></td>
              </tr>";
                                }
                            } else {
