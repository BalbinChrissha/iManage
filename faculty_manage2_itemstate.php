            ...
            <div class="div1">
                ...
                <div class="col-sm-9 mx-auto">
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="">Qty: Consumed</label>
                                <input type="number" name="unavailable1_qty" class="form-control mb-3" required>
                            </div>
                            <div class="col-lg-6">
                                <label for="">Qty: Expired (Perishable Items Only)</label>
                                <input type="number" name="unavailable2_qty" value="0" class="form-control mb-3" required>
                            </div>
