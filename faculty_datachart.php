...
if ((!isset($_GET['recordno'])) && (!isset($_GET['catID']))) {
    header('location: faculty_dashboard.php');
}


global $recordno, $categoryID;
...
if ($_GET['catID'] == 2) {
    header("location: faculty_datachart2.php?recordno=$recordno && catID=$catID");
} 
...
<?php if ((isset($_GET['recordno']))  && (isset($_GET['catID']))) : ?>
    <?php
    ...
    ?>
            ...
            <div class="col-10 mx-auto my-5 bg-light rounded">
                <input type="hidden" name="year" id="facultyID" value="<?php echo $_SESSION['faculty_incharge']['facultyID']; ?>">
