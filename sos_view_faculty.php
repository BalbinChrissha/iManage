...
<?php if (isset($_SESSION['supply_office_staff'])) : ?>
    ...
    <div class="col-10 mx-auto my-5 bg-light rounded">
      ...
      <td>$data[7]</td>
      <td>$data[8]</td>
      <td> <a href=\"sos_view_faculty_datachart.php?facultyid=$facultyID && recordno=" . $data[0] . " && catID=" . $data[9] . "\" ><i  input type=\"edit\"  class=\"fa-solid fa-eye\" style=\"color:blue;\"></i> Analytics</a></td>
              </tr>";
                                }
                            } else {
